...
public interface PricesApi {
	...
	@Operation(summary = "Create or update a price",
			description = "Creates a new price entry or updates an existing one")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Price created or updated successfully",
					content = { @Content(mediaType = "application/json",
							schema = @Schema(implementation = ApiPriceResponseDTO.class)) }),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Final price retrieved successfully",
					content = { @Content(mediaType = "application/json",
							schema = @Schema(implementation = ApiPriceResponseDTO.class)) }),
			@ApiResponse(responseCode = "400", description = "Invalid input", content = @Content),
			@ApiResponse(responseCode = "500", description = "Internal server error", content = @Content) })
	...
	@Operation(summary = "Find list of available prices by product",
			description = "list of available prices by product")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Find list of available prices by product",
					content = { @Content(mediaType = "application/json",
							schema = @Schema(implementation = ApiPriceResponseDTO.class)) }),
			@ApiResponse(responseCode = "400", description = "Invalid input", content = @Content),
			@ApiResponse(responseCode = "500", description = "Internal server error", content = @Content) })
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Delete a price",
					content = { @Content(mediaType = "application/json",
							schema = @Schema(implementation = ApiPriceResponseDTO.class)) }),
			@ApiResponse(responseCode = "400", description = "Invalid input", content = @Content),
			@ApiResponse(responseCode = "500", description = "Internal server error", content = @Content) })
